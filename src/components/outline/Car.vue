      ...
      <div style="background-color:#404a59;">
        ...
        <el-row style="padding:5px;">
          <el-col :span="20">
            ...
            {{title1}} &nbsp; &nbsp;
            目的地:<span class="text1">

              {{destination}} </span>
            </br>
            车号:<span class="carid">{{CarId}}
            </span></br>

            车辆负责人:
            <span class="fuzeren">{{CarManager}}</br>
            </span> 联系方式: <span class="fuzeren">{{phone}}
            </span>
        ...
        <el-row style="margin-bottom:10px;">
          ...
          <div v-else
            ...
            <div @click="showPatinfo=true">

              所载病人:<span class="text2">{{NowPatient}}</span> &nbsp;&nbsp;病情分级:<span class="text2">{{Classification}}</span> </br>
              预计送达时间:<span class="text2">{{Estimatedtime}}</span>
            </div>
          </div>
